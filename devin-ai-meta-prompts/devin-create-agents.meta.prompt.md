...
**Para orquestadores, añadir:**
6. **## Workflow** — Pasos por fases con gates `⏸️ PAUSE — Human approval required`.
7. **## Quick Reference** — Lista condensada de pasos para ejecución rápida.
